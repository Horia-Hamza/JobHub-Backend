...
exports.allApplicationsRouter = void 0;
...
exports.allApplicationsRouter = router;
router.get("/admin/job/:jobId/applications", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const applications = yield applicationModel_1.default.find({ jobId }).populate("jobId");

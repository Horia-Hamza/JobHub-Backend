...
exports.getApplicationRouter = void 0;
...
exports.getApplicationRouter = router;
router.get("/admin/job/:jobId/application/:applicationId", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if ((admin === null || admin === void 0 ? void 0 : admin.role) != "Admin") {
        return next(new bad_request_1.BadRequestError("not allowed to show or edit applications!"));
    }
    const job = yield jobModel_1.default.findById(jobId);
    if (!job) {
        return next(new bad_request_1.BadRequestError("can not find job!"));
    }
    const Application = yield applicationModel_1.default.findById(applicationId).populate("jobId");
    if (!Application) {
        return next(new bad_request_1.BadRequestError("can not find Application!"));
    }
